...
const FavoirtContact = ({ contacts, setContactList, ToggleFavorite,deleteFun }) => {
  return (
    <div className="favorit d-flex flex-column w-100 p-4 border-gray mt-2 ">
      ...
      <div className="d-flex flex-column border-gray">
        {contacts.map((item) => (
          <div
            className="d-flex  justify-content-evenly align-items-center py-4 px-2"
            key={item.id}
          >
            <div
            ...
            <div className="d-flex justify-content-evenly  w-100 ">
              <FavoriteBtn
                att={item.isFavorit ? "warning" : "secondary"}
                id={item.id}
